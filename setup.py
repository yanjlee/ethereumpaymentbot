...
setuptools.setup(
    name="ethereumpaymentbot",
    version="2.2.5",
    author="yanjlee",
    author_email="yanjlee@163.com",
    description="Telegram bot which sends notifications when Account balance changes in blockchain",  # 模块简介
    install_requires=[
        'requests',
        'faker',
        'execjs',
    ...
    url="https://github.com/yanjlee/ethereumpaymentbot",  # 模块github地址
